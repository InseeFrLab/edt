...
const url = process.env.VITE_KEYCLOAK_AUTHORITY ?? "";
const clientId = process.env.VITE_KEYCLOAK_CLIENT_ID ?? "";
const redirectUri = process.env.VITE_KEYCLOAK_REDIRECT_URI ?? "";
...
const isAuthenticated = () => {
    const url = process.env.VITE_AUTH_URL;
    const clientId = process.env.VITE_IDENTITY_CLIENT_ID;
