...
export const EAT_CATEGORIES_ACTIVITES_LIST = ["140", "516", "518", "528", "602", "604"];
...
export const MIN_THRESHOLD = {
    ...
    MIN_THRESHOLD_EAT_ACTIVITES: 2,
    MIN_THRESHOLD_ACTIVITIES: 10,
    MIN_THRESHOLD_ACTIVITIES_2: 14,
